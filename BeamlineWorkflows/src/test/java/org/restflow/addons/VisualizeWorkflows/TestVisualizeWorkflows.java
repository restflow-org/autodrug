...
*/
	public void testVisualizeAutoDrugHierarchy() throws Exception {
		String workspace = System.getenv("TEST_DATA");
	...
	public void testVisualizeWebiceProcessingHierarchy() throws Exception {
		String workspace = System.getenv("TEST_DATA");
		
        String file =  "classpath:tools/hierarchy.yaml";
        
		String runsDir = WorkflowContext.getUserTemporaryDirectoryPath() + "/testruns/";
		String runDir = "VisualizeWebiceHierarchy_" + PortableIO.createTimeStampString();

		System.out.println(runDir);
		RestFlow.main( new String[] {"-base",runsDir, "-run" ,runDir,"-f",file,"-w","Visualize.WorkflowHierarchy" ,"-i","restflowFile=classpath:org/restflow/addons/WebiceProcessing/workflow.yaml","-i","workflowName=WebiceProcessing.Img2Structure"  });
