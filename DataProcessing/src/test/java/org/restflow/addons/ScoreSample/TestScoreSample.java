...
public class TestScoreSample extends TestCase {
	...
	public void testScoreSample() throws Exception {
		...
		String image2 = new File("target/test-classes/org/restflow/addons/ScoreSample/inputs/1/B2_0002.cbf").getAbsolutePath();
        String validatePath = "target/test-classes/org/restflow/addons/ScoreSample/inputs/1/output.yaml";  
		String infile = "target/test-classes/org/restflow/addons/ScoreSample/inputs/1/infile.yaml";

		String runsDir = WorkflowContext.getUserTemporaryDirectoryPath() + "/testruns/";
		String runDir = "ScoreSample" + PortableIO.createTimeStampString();
